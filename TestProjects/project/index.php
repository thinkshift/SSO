...
<?php if(!$_SESSION["user"]){?>
	<a href="http://sso.app:8000/login?callBack=http://localhost:8888/project/index.php">Login</a>
<?php }else{?>
	<label>User: <?php echo $_SESSION["user"]->name; ?></label>
	<form method="post" action="http://sso.app:8000/logout">
		<input type="hidden" name="callBack" value="http://localhost:8888/project/index.php">
